...
import 'package:amazic_ads_flutter/base_my_app.dart';
...
class MyApp extends BaseMyApp {
  const MyApp({super.key, required super.navigatorKey});

  @override
  BaseMyAppState<BaseMyApp> createState() => _MyAppState();
}
